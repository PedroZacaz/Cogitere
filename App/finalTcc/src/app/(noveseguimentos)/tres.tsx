         ...
         <View style={styles.container}>
                ...
                <Ionicons name='arrow-back' size={20} color="#fff" />
                        ...
                        Pomadas, cremes e géis
                             ...
                             <Text style={styles.txt}>
                          1 -   Deixe na embalagem original.
                          Se o medicamento não for utilizado, mantenha-o na bisnaga e inutilize-o (corte ou fure antes de descartar).
                              </Text>
                             <Text style={styles.txt}>
                          2 -   Descartar no lixo comum.
                          Coloque a bisnaga em um saco plástico antes de descartá-la.
                             </Text>
