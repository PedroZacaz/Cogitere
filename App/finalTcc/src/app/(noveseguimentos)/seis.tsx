         ...
         <View style={styles.container}>
                ...
                <Ionicons name='arrow-back' size={20} color="#fff" />
                        ...
                        <Text style={styles.titulo}>         Modo de descarte</Text>
                             ...
                             <Text style={styles.txt}>
                          1 -   Retire da embalagem original.
                          Misture com resíduos orgânicos (como restos de alimentos) antes de descartar no lixo comum.
                             </Text>
                             <Text style={styles.txt}>
                          2 -  Recicle as embalagens.
                          Encaminhe as embalagens para a coleta seletiva.
                             </Text>
